  ...
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="退函审核状态">
          <el-select v-model="searchInfo.isRefunded" placeholder="选择条件" clearable>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="center" label="申请时间" width="100px">
          <template #default="scope">{{ date(scope.row.refund.CreatedAt) }}</template>
        </el-table-column>
